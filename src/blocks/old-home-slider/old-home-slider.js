if(window.getW() > window.sorpBP.smMax) {
    ...
    function redrawClipPath() {
        ...
        if (userAgent.includes('Safari/')) {
            ...
            if (parseInt(userAgent.split('Version/')[1]) < 14) {
                dd.setAttribute('style', '-webkit-clip-path: url(#animateSvg);');
                dd.setAttribute('style', 'clip-path: url(#animateSvg);');
            } else {
                dd.setAttribute('style', '-webkit-clip-path: url(#svgPath);');
                dd.setAttribute('style', 'clip-path: url(#svgPath);');
            }
        }
    }
